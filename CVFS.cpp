...
void man(char *name)
{
    ...
    else if(strcmp(name,"lseek") == 0)
    {
        ...
        printf("Usage : lseek File_nmae ChangeInOffset StartPoint\n");
    }
...
int LseekFile(int fd , int size, int from)
{
    ...
    else if(UFDTArr[fd].ptrfiletable->mode == WRITE)
    {
        ...
        else if(from == START)
        {
            ...
            if(size > (UFDTArr[fd].ptrfiletable->ptrinode->FileActualSize))
            {
                (UFDTArr[fd].ptrfiletable->ptrinode->FileSize) = size;
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminal the Marvellous Virtual File System\n");
                break;
            }
            else
            {
